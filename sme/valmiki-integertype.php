      ...
      <section class="">
        <div class="">
          <div class="row">
            <div class="col-lg-12">
              <section class="panel">
                <header class="panel-heading"> Valmiki - Integer Type <span class=" pull-right"> </span> </header>
                <div class="panel-body">
                  ...
                  <div class="col-md-8">
                    ...
                    <ul class="list-inline text-center">
                      <li>
                        <input class="checkbox-option" id="checkbox-00" type="chechbox" />
                        0</li>
                      <li>
                        <input class="checkbox-option" id="checkbox-01" type="chechbox" />
                        1</li>
                      <li>
                        <input class="checkbox-option" id="checkbox-02" type="chechbox" />
                        2</li>
                      <li>
                        <input class="checkbox-option click" id="checkbox-03" type="chechbox" />
                        3</li>
                      <li>
                        <input class="checkbox-option" id="checkbox-04" type="chechbox" />
                        4</li>
                      <li>
                        <input class="checkbox-option" id="checkbox-05" type="chechbox" />
                        5</li>
                      <li>
                        <input class="checkbox-option " id="checkbox-06" type="chechbox" />
                        6</li>
                      <li>
                        <input class="checkbox-option" id="checkbox-07" type="chechbox" />
                        7</li>
                      <li>
                        <input class="checkbox-option " id="checkbox-08" type="chechbox" />
                        8</li>
                      <li>
                        <input class="checkbox-option" id="checkbox-09" type="chechbox" />
                        9</li>
                    </ul>
                    <br>
					<center><span class="correct_answer">3 - Correct Answer</span></center>
                    <br>
