      ...
      <section class="">
        <div class="">
          <div class="row">
            <div class="col-lg-12">
              <section class="panel">
                <header class="panel-heading"> Uploading <span class=" pull-right"> </span> </header>
                <div class="panel-body">
                      ...
                      <tbody>
                        <tr>
                          <td><label class="label_radio" for="radio-01">
                              ...
                              A </label></td>
                          <td><div class="summernote">Hello Summernote</div></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                          <td><label class="label_radio" for="radio-03">
                              <input name="sample-radio" id="radio-03" value="1" type="radio" checked />
                              C </label></td>
                          <td><div class="summernote">Hello Summernote</div></td>
                        </tr>
                        <tr>
                  ...
                  <div class="col-md-4">
                    <table class="table table-bordered">
                      ...
                      <tbody class="radios">
                        <tr>
                          <td><label class="label_radio" for="radio011">
                              <input name="sample-radio" id="radio011" value="1" type="radio" checked />
                              M.C.Q. Single </label>
                            <!--<label class="label_radio" for="radio-02">
                              <input name="sample-radio" id="radio-02" value="1" type="radio" />
                              M.C.Q. Multiple </label>-->
                            <label class="label_radio" for="radio013">
                              <input name="sample-radio" id="radio013" value="1" type="radio" />
                              VSAQ </label>
                            <label class="label_radio" for="radio014">
                              <input name="sample-radio" id="radio-014" value="1" type="radio" />
                              LAQ </label>
                            <label class="label_radio" for="radio015">
                              <input name="sample-radio" id="radio-015" value="1" type="radio" />
                              Practical Skill </label>
                              <label class="label_radio" for="radio016">
                              <input name="sample-radio" id="radio-016" value="1" type="radio" />
                              SAQ </label>
                              <label class="label_radio" for="radio017">
                              <input name="sample-radio" id="radio017" value="1" type="radio" />
                              Map Pointing </label>
                              <label class="label_radio" for="radio018">
                              <input name="sample-radio" id="radio018" value="1" type="radio" />
                              Graphical Questoions </label>
                             </td>
                        </tr>
                      </tbody>
                    </table>
