      ...
      <section class="">
        <div class="">
          <div class="row">
            <div class="col-lg-12">
              <section class="panel">
                <header class="panel-heading"> Valmiki - Assention & Reason <span class=" pull-right"> </span> </header>
                <div class="panel-body">
                  ...
                  <div class="col-md-8">
                    ...
                    <input type="text" class="form-control" placeholder="Statement 1 (A)">
                    <br>
                    <input type="text" class="form-control" placeholder="Statement 2 (R)">
                    <br>
                    <div class="answer-options">
                    
                    <label class="label_radio" for="radio1">
                      <input name="sample-radio" id="radio1" value="1" type="radio"  />
                      <span class="choices">A :</span> Both A & R are true & R is correct explanition for A </label>
                    <label class="label_radio" for="radio2">
                      <input name="sample-radio" id="radio2" value="1" type="radio" checked />
                      <span class="choices">B :</span> Both A & R are true & R is correct explanition for A </label>
                    <label class="label_radio" for="radio3">
                      <input name="sample-radio" id="radio3" value="1" type="radio" />
                      <span class="choices">C :</span> A is true & R is false </label>
                    <label class="label_radio" for="radio4">
                      <input name="sample-radio" id="radio4" value="1" type="radio" />
                      <span class="choices">D :</span> Both A & R are false </label>
                      <br>
                      <span class="correct_answer">B - Correct Answer</span>
                      </div>
                      <br>
                          ...
                          <td><label class="label_radio" for="radio-01">
                           ...
                           <!-- <label class="label_radio" for="radio-06">
                            ...
                            <label class="label_radio" for="radio-07">
                              <input name="sample-radio" id="radio-07" value="1" type="radio" />
                              Map Pointing </label>
...
.checkboxes label, .radios label , .answer-options label{
    display: block;
    cursor: pointer;
    line-height: 20px;
    padding-bottom: 7px;
