      ...
      <section class="">
        <div class="">
          <div class="row">
            <div class="col-lg-12">
              <section class="panel">
                <header class="panel-heading"> Uploading - VSAQ <span class=" pull-right"> </span> </header>
                <div class="panel-body">
                  ...
                  <div class="col-md-8">
                    ...
                    <input type="text" class="form-control" placeholder="Marking Scheme">
                    <br>
                    <input type="text" class="form-control" placeholder="Marking Scheme">
                    <br>
                    <p><strong>Answer (Detailed)</strong></p>
                    <div class="summernote">Hello Summernote</div>
