                              ...
                              <div class="table-responsive">
                                  <table class="table table-bordered" id="mytable">
                                      ...
                                      <tr>
                                          ...
                                          <td>11</td>
                                          <td>Maths , Phisics , Chemistry , Biology , Psychology</td>
                             ...
                             Add New Board Class Subjects
                              ...
                              <div class="col-sm-3">
                                ...
                                <div class="col-sm-3">
                                	<div class="form-group">
                                    <br/>
                                    	 <button class="add_row btn-primary" type="submit" style="margin-top:7px;">Add Board &amp; Class &amp; Subjects <i class="fa fa-plus-circle"></i></button>
                                    </div>
                                </div>
