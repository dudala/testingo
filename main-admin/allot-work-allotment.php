                ...
                <section class="panel secound_tabs">
                  <header class="panel-heading tab-bg-dark-navy-blue ">
                    <ul class="nav nav-tabs">
                      <li class="active"> <a title="Allotment" href="allot-work-allotment.php">Allotment</a> </li>
                      <li> <a title="Allotment Report" href="allot-work-allotment-report.php">Allotment Report</a> </li>
