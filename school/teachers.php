      ...
      <section id="container">
         ...
         <section id="main-content">
            <section class="wrapper site-min-height">
             ...
             <a class="btn btn-primary pull-right" href="add-teachers.php">
                                    <i class="fa fa-plus-circle"></i> Add New Teachers </a>
             </span>
              </header>
              ...
              <tr class="gradeX">
                  ...
                  <td class="center "><div class="btn-group">
                                      <button class="btn btn-white" type="button">11/A</button>
                                      <button class="btn btn-white" type="button">10</button>
                                      <button class="btn btn-white" type="button">8/A</button>
                      <button class="btn btn-white" type="button">2/B</button>
                      <button class="btn btn-white" type="button">6/A</button>
                      <button class="btn btn-white" type="button">7/A</button>
                      <button class="btn btn-white" type="button">12/A</button>
                                  </div></td>
                  ...
                  <td>02</td>
                  <td>First Name Last Name</td>
                  <td><span class="label label-primary label-mini">Physics</span></td>
                  <td class="center "><div class="btn-group">
                                      <button class="btn btn-white" type="button">11/A</button>
                                      <button class="btn btn-white" type="button">10</button>
                                      <button class="btn btn-white" type="button">8/A</button>
                  ...
                  <td>03</td>
                  <td>First Name Last Name</td>
                  <td><span class="label label-danger label-mini">Chemistry</span></td>
                  <td class="center "><div class="btn-group">
                                      <button class="btn btn-white" type="button">11/A</button>
                                      <button class="btn btn-white" type="button">10</button>
                                      <button class="btn btn-white" type="button">8/A</button>
                  ...
                  <td>04</td>
                  <td>First Name Last Name</td>
                  <td><span class="label label-warning label-mini">Maths</span></td>
                  <td class="center "><div class="btn-group">
                                      <button class="btn btn-white" type="button">11/A</button>
                                      <button class="btn btn-white" type="button">10</button>
                                      <button class="btn btn-white" type="button">8/A</button>
                  ...
                  <td>05</td>
                  <td>First Name Last Name</td>
                  <td><span class="label label-success label-mini">English</span></td>
                  <td class="center "><div class="btn-group">
                                      <button class="btn btn-white" type="button">11/A</button>
                                      <button class="btn btn-white" type="button">10</button>
                                      <button class="btn btn-white" type="button">8/A</button>
