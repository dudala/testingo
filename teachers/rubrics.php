      ...
      <section class="panel secound_tabs">
        <header class="panel-heading tab-bg-dark-navy-blue " style="padding:0px;">
          <ul class="nav nav-tabs">
            <li class="active"> <a title="Time Table" href="rubrics.php"><i class="fa fa-calendar"></i> Time Table</a> </li>
            <li class=""> <a title="Teaching Reports" href="rubrics-teaching-reports.php"><i class="fa fa-file-text-o" ></i> Teaching Reports</a> </li>
