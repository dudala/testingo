        ...
        <div class="panel-body">
          <div class="tab-content"><br/>
            <div id="syllabus-upload" class="tab-pane active">
              <div class="row">
                <div class="col-md-8">
                  <div id="tab" class="btn-group"> <a href="drona.php" class="btn btn-success active" ><i class="fa fa-upload"></i> Upload</a> <a href="drona-syllabus-status.php" class="btn btn-primary" ><i class="fa fa-bar-chart-o"></i> Status</a> </div>
...
$(document).ready(function(){
    ...
    var fieldHTML = '<div><input type="text" name="field_name[]" value=""/><a href="javascript:void(0);" class="remove_button" title="Remove field"><i class="fa fa-minus-circle"></i>Remove</a></div>'; //New input field html 
