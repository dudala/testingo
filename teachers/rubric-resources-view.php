            ...
            <section id="flip-scroll">
              <div class="row">
                <div class="panel-body col-md-4 ">
                  <div class="btn-group btn-group-justified"> <a class="btn btn-primary " href="rubric-resources.php"><i class="fa fa-upload"></i> Upload</a> <a class="btn btn-primary active" href="rubric-resources-view.php"><i class="fa fa-eye"></i> View</a> </div>
                  <h3>View</h3>
                </div>
