      ...
      <section class="panel secound_tabs">
        <header class="panel-heading tab-bg-dark-navy-blue " style="padding:0px;">
          <ul class="nav nav-tabs">
            ...
            <li> <a title="Assignments / Worksheets" href="valmiki-assignments-worksheets.php">Assignments / Worksheets</a> </li>
            <li class="active"><a title="Archives" href="valmiki-archives.php">Archives</a></li>
          </ul>
        </header>
            ...
            <div id="syllabus-upload" class="tab-pane active">
              <div class="row">
                <div class="col-md-8"> <br/>
                  <div id="tab" class="btn-group"> <a href="valmiki-archives.php" class="btn btn-primary active"><i class="fa fa-group"></i> 10th Class</a> <a href="valmiki-11thclass-archives.php" class="btn btn-primary"><i class="fa fa-group"></i> 11th Class</a> <a href="valmiki-12thclass-archives.php" class="btn btn-primary" ><i class="fa fa-group"></i> 12th Class</a> </div>
                  <br/>
