        ...
        <div class="panel-body">
          <div class="tab-content">
            <div id="syllabus-upload" class="tab-pane active"> <br/>
              <div class="row">
                <div class="col-md-8">
                  <div id="tab" class="btn-group"> <a href="valmiki.php" class="btn btn-primary " ><i class="fa fa-upload"></i> Upload</a> <a href="valmiki-syllabus-status.php" class="btn btn-primary active" ><i class="fa fa-bar-chart-o"></i> Status</a> </div>
