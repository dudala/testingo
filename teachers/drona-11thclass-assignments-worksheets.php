      ...
      <section class="panel secound_tabs">
        <header class="panel-heading tab-bg-dark-navy-blue " style="padding:0px;">
          <ul class="nav nav-tabs">
            ...
            <li class="active"> <a title="Assignments / Worksheets" href="drona-assignments-worksheets.php"><i class="fa fa-calendar "></i> Assignments / Worksheets</a> </li>
          ...
          <div class="tab-content">
            <div id="syllabus-upload" class="tab-pane active"> 
              ...
              <div class="row">
                <div class="col-md-8">
                <br/>
                	<div id="tab" class="btn-group"> <a href="drona-assignments-worksheets.php" class="btn btn-primary "><i class="fa fa-group"></i> 10th Class</a> <a href="drona-11thclass-assignments-worksheets.php" class="btn btn-primary active"><i class="fa fa-group"></i> 11th Class</a> <a href="drona-12thclass-assignments-worksheets.php" class="btn btn-primary"><i class="fa fa-group"></i> 12th Class</a> </div>
                    <br/>
