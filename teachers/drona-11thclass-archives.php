            ...
            <div id="syllabus-upload" class="tab-pane active">
              <div class="row">
                <div class="col-md-8"> <br/>
                  <div id="tab" class="btn-group"> <a href="drona-archives.php" class="btn btn-primary "><i class="fa fa-group"></i> 10th Class</a> <a href="drona-11thclass-archives.php" class="btn btn-primary active"><i class="fa fa-group"></i> 11th Class</a> <a href="drona-12thclass-archives.php" class="btn btn-primary" ><i class="fa fa-group"></i> 12th Class</a> </div>
                  <br/>
