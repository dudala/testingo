            ...
            <section id="flip-scroll">
              <div class="row">
                <div class="panel-body col-md-4 ">
                  <div class="btn-group btn-group-justified"> <a class="btn btn-primary " href="rubrics-academic-planner.php"><i class="fa fa-calendar"></i> Planner</a> <a class="btn btn-primary active" href="rubrics-academic-planner-view.php"><i class="fa fa-eye"></i> View</a> </div>
                  <h3>View</h3>
                </div>
