      ...
      <section class="panel secound_tabs">
        <header class="panel-heading tab-bg-dark-navy-blue " style="padding:0px;">
          <ul class="nav nav-tabs">
            <li class="active"> <a title="Syllabus Upload" href="valmiki.php">Syllabus Upload </a> </li>
            <li class=""> <a title="Assignments / Worksheets" href="valmiki-assignments-worksheets.php">Assignments / Worksheets</a> </li>
        ...
        <div class="panel-body">
          <div class="tab-content"><br/>
            <div id="syllabus-upload" class="tab-pane active">
                ...
                <div class="row">
                      <div class="col-md-8">
                      		<div id="tab" class="btn-group"> <a href="valmiki.php" class="btn btn-success active" ><i class="fa fa-upload"></i> Upload</a> <a href="valmiki-syllabus-status.php" class="btn btn-primary" ><i class="fa fa-bar-chart-o"></i> Status</a> </div>
                        ...
                        <table class="table table-bordered table-striped table-advance table-hover">
                          ...
                          <tbody>
                            <tr>
                              ...
                              <td><input class="form-control form-control-inline input-medium" placeholder="11/02/2018" disabled  type="text" value="" /></td>
                              <td><input type="text" class="form-control" placeholder="ex: Maths" disabled></td>
                              <td width="200"><select id="mst22" multiple="multiple" class="form-control">
                                  <option value="1" selected>Select Syllabus </option>
                                  <option value="1">Select Syllabus 1</option>
                                  <option value="1">Select Syllabus 2</option>
                                  <option value="1">Select Syllabus 3</option>
                                  <option value="1">Select Syllabus 4</option>
                                </select></td>
                              <td><input type="text" class="form-control" placeholder="50" disabled></td>
                              <td><input type="text" class="form-control" placeholder="ex: "></td>
                              <td><button class="btn btn-md btn-success">Sumbit</button></td>
                            </tr>
                          </tbody>
                        </table>
                      </div>
