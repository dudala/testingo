      ...
      <section class="panel secound_tabs">
        <header class="panel-heading tab-bg-dark-navy-blue " style="padding:0px;">
          <ul class="nav nav-tabs">
            ...
            <li class="active"> <a title="Teaching Reports" href="rubrics-teaching-reports.php"><i class="fa fa-file-text-o" ></i> Teaching Reports</a> </li>
              ...
              <table class="table table-striped table-advance table-hover">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td><button class="btn btn-md btn-success" type="file"><i class="fa fa-paperclip"></i></button></td>
                        </tr>
                        <tr>
                          <td> Period 1 </td>
                          <td>11-A </td>
                          ...
                          <td><button class="btn btn-md btn-success"><i class="fa fa-paperclip"></i></button></td>
                        </tr>
                        <tr>
                          <td> Period 1 </td>
                          <td>11-A </td>
