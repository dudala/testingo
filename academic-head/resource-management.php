                    ...
                    <section class="panel secound_tabs">
                      <header class="panel-heading tab-bg-dark-navy-blue " style="padding:0px;">
                        <ul class="nav nav-tabs">
                           <li class="active"> <a title="Role" href="resource-management.php">Role</a> </li>
                          ...
                          <div id="school_schedule" class="tab-pane active">
                            <section class="panel">
                              <div class="panel-body"> 
                                ...
                                <div class="action_buttons text-center col-sm-10"> <a href="#" class="btn btn-primary">Save</a> <a href="#" class="btn btn-danger">Edit</a> </div>
...
<link href="sme/assets/advanced-datatable/media/css/demo_table.css" rel="stylesheet"/>
<link rel="stylesheet" href="sme/assets/data-tables/DT_bootstrap.css"/>
...
<script src="../sme/js/advanced-form-components.js"></script> 
<script>
         $( function () {
