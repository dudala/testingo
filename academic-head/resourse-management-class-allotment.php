                                      ...
                                      <div class="col-sm-9">
                                        ...
                                        <div class="subjects_buttons">
                                          ...
                                          <div class="tab-content">
                                            ...
                                            <div id="physics" class="tab-pane fade"> physics </div>
                                            <div id="computer-science" class="tab-pane fade"> computer science </div>
                                          </div>
                                        </div>
                                      </div>
                                      <div class="col-sm-3">
                                        <div class="explain_colors">
                                          <div class="red"> <span class="red-box box"></span><span class="title">Pending</span> </div>
                                          <div class="red"> <span class="gray-box box"></span><span class="title">Selection</span> </div>
                                          <div class="red"> <span class="green-box box"></span><span class="title">Alloted</span> </div>
                                        </div>
                                      </div>
                                    </div>
                                    <!--main end here---> 
